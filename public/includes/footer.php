    ...
    <div class="container">
        <div class="footer-store-detail d-flex justify-content-between">
            <div class="footer-logo">
                <a href="/">
                    <img src="Maharaja Supermarket-white_v=1716044168.png" loading="lazy" alt="footer logo">
                </a>
            </div>
                        ...
                        <a href="https://www.facebook.com/Maharaja Supermarketpl/" target="_blank">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <path
                                    ...
                                    stroke="#5B8A1D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                </path>
                            </svg>
                        ...
                        <div class="icon-text">
                            <div class="icon-text__icon">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25"
                                    ...
                                    <path d="M12.6665 11.5V18.5" stroke="white" stroke-width="2" stroke-linecap="round">
                                    </path>
                                    <path
                        ...
                        <a class="icon-text align-items-center" href="tel:072893723 , 0723242211 7">
                            <div class="icon-text__icon">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25"
                                    ...
                                    <path d="M11.6665 19.5H13.6665" stroke="white" stroke-width="1.5"
                        ...
                        <a class="icon-text align-items-center" href="mail:shop@maharajasupermarket.ro">
                            <div class="icon-text__icon">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25"
                                    fill="none">
                                    <path
                                        d="M2.6665 6.5L9.57952 10.417C12.1281 11.861 13.2049 11.861 15.7535 10.417L22.6665 6.5"
                                        stroke="white" stroke-width="1.5" stroke-linejoin="round"></path>
                                    <path
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="supported-payment-providers">
                        <img src="Frame_7628_thumb_v=1716135418.svg" loading="lazy" alt="payment provider">
                        <img src="Frame_7627_thumb_v=1716135435.svg" loading="lazy" alt="payment provider">
                        <img src="Frame_7626_thumb_v=1716135441.svg" loading="lazy" alt="payment provider">
                        <img src="przelewy_thumb_v=1728244570.svg" loading="lazy" alt="payment provider">
                        <img src="blik_thumb_v=1728244592.svg" loading="lazy" alt="payment provider">
                    </div>
                </div>
            </div>
        </div>
...
<div id="shopify-section-recommendations-product" class="shopify-section recommendations-product">
    <!-- Optional scripts here -->
</div>

<ul hidden="">
    <li id="a11y-refresh-page-message">Choosing a selection results in a full page refresh.</li>
</ul>
<!-- Scripts from index.php -->
<!-- External scripts removed to prevent CORS/Reference errors -->
<script>
